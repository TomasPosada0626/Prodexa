...
Calificación agregada: **~86/100 (B+)**. Plan concreto para subirla, pilar por pilar, en [`docs/gestion/roadmap-calidad-90.md`](docs/gestion/roadmap-calidad-90.md) — el número se actualiza ahí primero y se propaga a este README, para que no queden desincronizados.
