...
## Vision
Prodexa sera la plataforma de referencia para gestionar recetas alimenticias, costeo y decisiones de precio con trazabilidad, reduciendo errores manuales y acelerando la toma de decisiones de negocio.
...
- Permite evaluar rentabilidad por receta, lote, unidad y kilogramo.
