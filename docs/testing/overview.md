...
```
      ...
      ╱   ╲ 257 unit backend (Jest) + 43 unit frontend (Vitest)
     ╱─────╲
```
...
|---|---|---|
| Backend unit | `npm run test:backend` | 257 tests, Jest, Prisma mockeado — servicios, guards, DTOs, el motor de costeo |
