  ...
  if (user && user.rol !== 'ADMIN') {
    return (
      <section className="grid gap-6">
        <div>
          <h2 className="font-heading text-2xl font-bold text-slate-900 dark:text-white">Auditoria</h2>
        </div>
        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-white/3 dark:shadow-none">
              ...
              <p className="mt-1 font-mono text-3xl font-bold text-slate-900 dark:text-white">{eventos?.length}</p>
            </div>
            <div
              className={
                loginsFallidos24h > 0
            ...
            >
              ...
              <p
                className={`mt-1 font-mono text-3xl font-bold ${loginsFallidos24h > 0 ? 'text-red-800 dark:text-red-300' : 'text-slate-900 dark:text-white'}`}
              >
                {loginsFallidos24h}
              </p>
            </div>
